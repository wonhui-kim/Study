			...
			<tr>
				...
				<td>
					<form name="form1" method="POST" action="calc_result.jsp">
						<input type="text" name="num1" value="0" width=10 size=5 style="text-align: center"><br>
						...
						<input type="text" name="num2" value="0" width=10 size=5 style="text-align: center"><br>
